...
<head>
    ...
    <!-- <link href=" <?= base_url('fontawesome/css/fontawesome.css'); ?>" rel="stylesheet" type="text/css"> -->
...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
    <div id="wrapper">
            <?= $this->include('Admin/Layout/sidebarAdmin_v'); ?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle mr-2" src="<?= base_url('admin/img/undraw_profile.svg'); ?>">
                            </a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="/Login/logout">Ya</a>
                    </div>
                </div>
            </div>
        </div>
